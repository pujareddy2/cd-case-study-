...
static const char *const yytname[] =
{
  ...
  "PLUS", "MINUS", "MUL", "DIV", "LPAREN", "RPAREN", "$accept", "program",
...
{
       0,     0,     0,     2,     3,     0,     1,     4,    13,    14,
       0,     5,     8,    11,     0,     0,     0,     0,     0,    12,
       6,     7,     9,    10
};
...
{
       8,     9,    15,    16,    15,    16,     1,    10,     6,    19,
      17,    18,    22,    23,    20,    21,     5,     7,     0,    14
};

static const yytype_int8 yycheck[] =
{
       3,     4,     6,     7,     6,     7,     3,    10,     0,    11,
       8,     9,    17,    18,    15,    16,     5,     3,    -1,    10
};
...
{
       0,     3,    13,    14,    15,     5,     0,    15,     3,     4,
      10,    16,    17,    18,    16,     6,     7,     8,     9,    11,
      17,    17,    18,    18
};
...
#line 45 "parser.y"
                   {
        ASTNode *id_node = create_id_node((yyvsp[-2].str));
        insert_symbol((yyvsp[-2].str), "ID", "Global", "int");
        (yyval.node) = create_assign_node(id_node, (yyvsp[0].node));
        ...
        char result_var[50];
        generate_tac((yyval.node), result_var);
        print_tac();
        clear_tac();
    }
...
#line 75 "parser.y"
        ...
        insert_symbol((yyvsp[0].str), "ID", "Global", "int");
    }
